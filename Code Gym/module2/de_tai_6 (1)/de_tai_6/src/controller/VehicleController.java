...
public class VehicleController {
    ...
    public void list() {
        ...
        do {
            choose = view.display();
            try {
                Function function = Function.values()[choose - 1]; // Function.values() sẽ trả về một mảng chứa các giá trị này theo thứ tự tương ứng, bắt đầu từ 0, truy cập vị trí choose - 1
                switch (function) {
